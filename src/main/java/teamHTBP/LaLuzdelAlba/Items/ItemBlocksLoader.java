...
public class ItemBlocksLoader {
    ...
    protected static Item.Properties BASIC_PROPERTY = new Item.Properties().tab(TAB_ENVIRONMENT);
    ...
    public static final RegistryObject<Item> SPIRAL_SMOKY_GRASS = ITEMBLOCKS.register("spiral_smoky_grass", ()->new BlockItem(BlocksLoader.SPIRAL_SMOKY_GRASS.get(),BASIC_PROPERTY));
    ...
    public final static RegistryObject<Item> SMOKY_PLANKS = ITEMBLOCKS.register("smoky_planks", ()->new BlockItem(BlocksLoader.SMOKY_PLANKS.get(),BASIC_PROPERTY));
    public final static RegistryObject<Item> SPIRAL_SMOKY_PLANKS = ITEMBLOCKS.register("spiral_smoky_planks", ()->new BlockItem(BlocksLoader.SPIRAL_SMOKY_PLANKS.get(),BASIC_PROPERTY));
    public final static RegistryObject<Item> MARSH_SMOKY_PLANKS = ITEMBLOCKS.register("marsh_smoky_planks", ()->new BlockItem(BlocksLoader.MARSH_SMOKY_PLANKS.get(),BASIC_PROPERTY));
